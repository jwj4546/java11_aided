package sec3;
//PMD : 코드 인스펙션 => 소스 코드 검증하여 성능 개선, 코드 작성 규칙 준수, 에러 발생 가능성 최소화하기 위한 작업
//Code Inspection Level
//name			Symbol			Level				Comment
//Blocker			빨간색				 High				필수, 에러 발생 가능성이 매우 높거나 메모리 누수가 발생되는 
//Critical			시안				Medium High	권고 상, 에러 발생 가능성이 높거나 일반적으로 수정되어야 하는
//Urgent			초록				Medium			(Major) 권고 중, 에러 발생이 있거나 수정을 권고하는 중요
//Important		마젠타				Medium Low	(Mino) 소스코드의 가독성, 유지 보수성 향상을 위해 수정을 
