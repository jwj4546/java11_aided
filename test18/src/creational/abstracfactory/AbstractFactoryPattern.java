...
그러므로, Abstract Factory Pattern은 관련 있는 객체들을 모아서 팩토리로 만들고 조건에 따라 팩토리 중에서 선택하게 하는 패턴
*/
public class AbstractFactoryPattern {
	public static void main(String[] args) {
		...
		Link daumLink = factory.createLink("다음", "htttps://www.daum.net");
		...
		final Page page = factory. createPage("검색엔진 리스트", "조우진");
		page.add(searchTray);
