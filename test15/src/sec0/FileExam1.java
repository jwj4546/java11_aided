...
public class FileExam1 {
	public static void main(String[] args) throws IOException{
		String file1 = "d:\\cho\\java2\\a.txt";					//로컬 경로
		String file2 = "http://192.168.1.104/data/manual/java.txt";					//원격 경로(url)
		...
		System.out.println("자바 디렉토리(sun.boot.class.path) : "+System.getProperty("sub.boot.class.path"));
		System.out.println("운영 체제(OS) 환경변수 값 : "+System.getenv());
